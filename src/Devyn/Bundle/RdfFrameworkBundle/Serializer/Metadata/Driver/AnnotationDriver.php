<?php
namespace Devyn\Bundle\RdfFrameworkBundle\Serializer\Metadata\Driver;
use Devyn\Bundle\RdfFrameworkBundle\Serializer\Annotation\JsonLd;
use Devyn\Bundle\RdfFrameworkBundle\Serializer\Metadata\ClassMetadata;
