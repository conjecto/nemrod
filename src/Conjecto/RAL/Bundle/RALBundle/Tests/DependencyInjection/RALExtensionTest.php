<?php
namespace Conjecto\RAL\Bundle\RALBundle\Tests\DependencyInjection;

use Conjecto\RAL\Bundle\RALBundle\DependencyInjection\RALExtension;
...
class RALExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->container->setParameter('kernel.bundles', array('Conjecto\RAL\Bundle\RALBundle\Tests\Fixtures\TestBundle\FixtureTestBundle'));
