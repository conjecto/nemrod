<?php
namespace Conjecto\RAL\Bundle\RALBundle\Serializer\Metadata\Driver;

use Doctrine\Common\Annotations\Reader;
use JMS\Serializer\Metadata\Driver\AnnotationDriver as BaseAnnotationDriver;

/**
 * Extending AnnotationDriver to handle Conjecto\RAL\Bundle\RALBundle* @package Conjecto\RAL\Bundle\Serializer\Metadata\Driver;
 */
